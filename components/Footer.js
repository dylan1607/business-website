...
const Footer = () => {
  return (
    ...
    <div id="footer" className="bg-gray-600 md:px-10">
      <footer class="flex justify-between p-6 footer text-white">
        <div>
        ...
        <div>
          ...
          <Link class="link link-hover" href="/contact">
            Liên hệ
          </Link>
          <Link class="link link-hover" href="">
            Công việc
        ...
        <div>
          <span class="footer-title">Chính sách</span>
      ...
      >
        ...
        <div class="md:place-self-center md:justify-self-start">
